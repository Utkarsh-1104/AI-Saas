...
export default function AnalysisDetails(Prop: { analysis: Analysis }) {
    ...
    return (
        ...
        <div className="max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
            ...
            <h2 className="text-xl font-medium mt-4 max-w-3xl mx-auto">{analysis.jdText}</h2>
            </div>
            ...
            <div className="inline-flex items-center justify-center w-32 h-32 border-2 border-black rounded-full mb-4">
                <span className="text-3xl font-light">{parseAnalysis(analysis.analysis).match_score * 100}%</span>
            </div>
            ...
            <p className="text-gray-700 leading-relaxed text-lg max-w-4xl">{parseAnalysis(analysis.analysis).overall_comment}</p>
            </div>
